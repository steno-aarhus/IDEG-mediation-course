...
outcome (aetiological epidemiology). Once this effect is established, the next natural question is
to explore the "black box"—the underlying mechanisms that explain how
the exposure (or intervention) leads to the observed outcome. As we are
not only interested in whether an exposure/intervention has an effect, but in how this effect works
@vanderweele_mediation_2016.

Mediation analysis provides an answer to this HOW question, by
quantitatively exploring the pathways and mechanisms that explain the causal
relationship between the exposure (or intervention or treatment) and
