...
-   **ADE** is the Average Direct Effect. It describes the direct
    effect of the exposure (X) on the outcome (Y) when controlling for the mediator (M). Note
...
-   **ACME** is the Average Causal Mediation Effect. This is the
    indirect effect of the exposure (X) on the outcome (Y) that goes through the mediator (M).
...
-   **Total Effect** is the Total Effect (direct + indirect) of the exposure (X) on the outcome (Y).
    We can also get it by adding the ACME (-0.335) and the ADE (-1.423).

-   **Prop. Mediated** is the proportion of the effect of the exposure (X) on the outcome (Y)
