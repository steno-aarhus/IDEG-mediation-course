...
indirect pathways. For natural mediation effects, we need to consider
scenarios that cross between different possible worlds, such as: What
would my risk of getting T2D be if I take the pill (treatment = 1), BUT
my BMI remained at the level it would have been had I NOT taken the pill
(mediator at level from treatment = 0), compared to the risk of T2D if I
had taken the pill, and my BMI were at the level it would naturally
reach under treatment (treatment =1).
...
Direct effect: $E[(Y(a=1,M_a=0))$ - $Y(a=0,M_a=0))]$ Indirect effect:
$E[(Y(a=1,M_a=1))$ - $Y(a=1,M_a=0))]$
