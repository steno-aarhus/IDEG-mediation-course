...
> Will take the magin pill reduce my risk of developing T2D in 5 years?
...
This is then compared to what my blood glucose would be if both my red
meat consumption AND my body fat percentage were at their treated levels
(treatment = 1, mediator at level from treatment = 1).
...
![cross-world
counterfacturals](/images/decompose.png){#fig-decompose}
...
**abcense** of physical activity(**a=0**).
