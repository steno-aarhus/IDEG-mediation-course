...
But we can never do this in the real world. Only ever observe one of Y(0) or Y(1) the other is counterfactual.
...
-   Exchangeability and cross-world independence

    *The risk of the outcome in A = 1 would have been the same as the risk of the outcome in A = 0, had those in A = 1 received A = 0*.

-   Consistency

    *An individual's potential outcome under the observed exposure should be equal to the observed outcome*.
...
when there are interaction and non-linearity, differet ways of accounting for the interaction:
