...
A Directed Acyclic Graph (DAG) is a visual tool for representing causal relationships between variables.
When we’re assessing the causal effect between an exposure and an outcome, drawing our assumptions in the form of a DAG can help us pick the right model without having to know much about the math behind it.

How could DAG be used in Epidemioloical research?

-   Identify the existence of confounding (*check exchangeability between exposure and unexposed)*
