...
In order to participate in this course actively, you recommend you complete the pre-course tasks.
...
3.  Download the data or the repository in ??sec-download-data(add later)
...
We designed an introduction to Directed Acyclic Graph, please get yourself familiar with this tool.
