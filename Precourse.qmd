...
1.  Read the learning objectives in ???sec-learning-objectives (add
    later)
2.  Install the necessary programs in ???sec-intall-r-packages(add
    later)
3.  Read the Code of Conduct ???sec-code-of-conduct(add later)
4.  Download the data or the repository in ??sec-download-data(add
    later)
...
To introduce participants to background principles, tools and skills to
understand and apply modern mediation analysis for investigation of
disease mechanisms.
:::
...
Beside R, you will need to download and install [R Studio
Desktop](https://posit.co/downloads/). This is a separate program that
provides an intuitive user interface with R.

### More detailed instructions.

You can find more detailed instructions for [installing R and R
Studio](https://rstudio-education.github.io/hopr/starting.html) here.

### Check your version of R

If you already have a previously installed R and R Studio, please check
your R version.
...
We recommend that you do not do this before March 31, in the afternoon
as we will making updates until then.
