...
If you want to only download the workshop data. You can go to [here](https://github.com/steno-aarhus/mediation-analysis-course/tree/main/data) for the Framingham, NHANES and simulated data. Click "download raw file" in the top right corner after you have clicked on the specific file.
...
Everyone who participates in this workshop’s activities is required to conform to this Code of Conduct. It applies to all spaces associated with this workshop including, but not limited to, group work, emails, and any online forums such as GitHub and X(Twitter). By participating, participants indicate their acceptance of the procedures by which the instructors and organizers resolves any Code of Conduct incidents.
